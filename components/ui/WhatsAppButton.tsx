...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-28 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-xl transition-transform duration-200 hover:scale-105"
